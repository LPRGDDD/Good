		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form1" role="form" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="goodsid" class="form-control" id="goodsid">
							...
							<label class="col-sm-2 control-label">出产日期</label>
							<div class="col-sm-2">
								<input type="date" name="goodsdate" class="form-control" id="goodsdate">
							</div>
							<div class="layui-form-item layui-form-text">
						    <label class="layui-form-label">商品简介</label>
						    <div class="layui-input-block">
								<textarea name="goodsdesc" id="" placeholder="请输入内容" class="layui-textarea"><span id="goodsdesc"></span></textarea>
						    </div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" onclick="upload()">文件上传</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" class="btn btn-primary" id="add" onclick="add()">提交</button>
					<button type="button" class="btn btn-primary" onclick="JsonUpdate()">修改</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
...
<script type="text/javascript">
        ...
        $.ajax({
                ...
                success : function(data) {
                    ...
                    for(var i=0;i<ary.length;i++){
                        ...
                        tr+="<td><input data-toggle='modal' data-target='#myModal2' type='button' value='修改' id="+obj.goodsid+" class='getGoods btn btn-default'/>"
                        tr+="<input type='button' value='删除' id="+obj.goodsid+" class='del btn btn-default'/></td>";
                        tr+="</tr>";
    ...
    /* 单个商品查询 */
    $("#tbody1").on("click", ".getGoods", function() {
         var goodsid = this.id;
        alert(goodsid);
        $.ajax({
            url : "goods/findById",
